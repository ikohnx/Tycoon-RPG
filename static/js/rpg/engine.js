    ...
    function drawSprite(type, x, y, facing, frame, moving, color, spriteId) {
        ...
        switch(facing) {
            case 'down': {
                ...
                ctx.beginPath();
                ctx.ellipse(x + 24, sy + by + 10, 12, 10, 0, 0, Math.PI * 2);
                ctx.fill();
                if (hasHat) {
                    ctx.fillStyle = pal.hat || pal.hair;
                    ctx.beginPath();
                    ctx.ellipse(x + 24, sy + by + 3, 15, 7, 0, 0, Math.PI * 2);
                    ctx.fill();
                    ctx.fillStyle = pal.hatHL || pal.hairHL;
                    ctx.beginPath();
                    ctx.ellipse(x + 22, sy + by + 2, 10, 4, 0, 0, Math.PI * 2);
                    ctx.fill();
                    ctx.fillStyle = pal.hatDk || pal.hairDk;
                    ctx.fillRect(x + 10, sy + by + 5, 28, 3);
                    ctx.fillStyle = pal.hatMd || pal.hat || pal.hair;
                    ctx.fillRect(x + 14, sy + by + 3, 20, 2);
                } else {
                    ctx.fillStyle = pal.hairDk || pal.hair;
                    ctx.beginPath();
                    ctx.ellipse(x + 24, sy + by + 4, 12, 8, 0, 0, Math.PI * 2);
                    ctx.fill();
                    ctx.fillStyle = pal.hair;
                    ctx.beginPath();
                    ctx.ellipse(x + 24, sy + by + 6, 11, 7, 0, 0, Math.PI * 2);
                    ctx.fill();
                    ctx.fillStyle = pal.hairHL;
                    ctx.beginPath();
                    ctx.ellipse(x + 22, sy + by + 4, 7, 4, 0, 0, Math.PI * 2);
                    ctx.fill();
                    ctx.fillStyle = pal.hairMd || pal.hair;
                    ctx.fillRect(x + 12, sy + by + 8, 24, 3);
                    ctx.fillStyle = pal.hairTip || pal.hairHL;
                    ctx.fillRect(x + 20, sy + by + 2, 3, 2);
                    ctx.fillRect(x + 25, sy + by + 1, 3, 2);
                    if (isHero) {
                        ctx.fillStyle = pal.hair;
                        ctx.fillRect(x + 10, sy + by + 3, 4, 7);
                        ctx.fillRect(x + 34, sy + by + 3, 4, 7);
                        ctx.fillStyle = pal.hairDk || pal.hair;
                        ctx.fillRect(x + 15, sy + by - 3, 3, 5);
                        ctx.fillRect(x + 21, sy + by - 5, 3, 7);
                        ctx.fillRect(x + 27, sy + by - 4, 3, 6);
                        ctx.fillRect(x + 33, sy + by - 2, 3, 4);
                        ctx.fillStyle = pal.hairHL;
                        ctx.fillRect(x + 16, sy + by - 2, D, 3);
                        ctx.fillRect(x + 22, sy + by - 4, D, 4);
                        ctx.fillRect(x + 28, sy + by - 3, D, 3);
                    }
                }
                ctx.fillStyle = pal.skin;
                ctx.beginPath();
                ctx.ellipse(x + 24, sy + by + 13, 10, 7, 0, 0, Math.PI * 2);
                ctx.fill();
                ctx.fillStyle = pal.skinHL || pal.skin;
                ctx.beginPath();
                ctx.ellipse(x + 22, sy + by + 11, 6, 4, 0, 0, Math.PI * 2);
                ctx.fill();
                ctx.fillStyle = pal.skinSh;
                ctx.fillRect(x + 15, sy + by + 16, 18, 2);
                ctx.fillStyle = pal.skinRim || pal.skinSh;
                ctx.fillRect(x + 17, sy + by + 18, 14, D);
                ctx.fillStyle = pal.eyeW || '#f0f0ff';
                ctx.fillRect(x + 16, sy + by + 10, 6, 4);
                ctx.fillRect(x + 26, sy + by + 10, 6, 4);
                ctx.fillStyle = pal.outline;
                ctx.fillRect(x + 16, sy + by + 9, 6, D);
                ctx.fillRect(x + 26, sy + by + 9, 6, D);
                ctx.fillRect(x + 15, sy + by + 10, D, 4);
                ctx.fillRect(x + 22, sy + by + 10, D, 4);
                ctx.fillRect(x + 25, sy + by + 10, D, 4);
                ctx.fillRect(x + 32, sy + by + 10, D, 4);
                ctx.fillRect(x + 16, sy + by + 14, 6, D);
                ctx.fillRect(x + 26, sy + by + 14, 6, D);
                ctx.fillStyle = pal.eye;
                ctx.fillRect(x + 17, sy + by + 10, 4, 3);
                ctx.fillRect(x + 27, sy + by + 10, 4, 3);
                ctx.fillStyle = pal.eyeHL || '#4060d0';
                ctx.fillRect(x + 18, sy + by + 10, 2, 2);
                ctx.fillRect(x + 28, sy + by + 10, 2, 2);
                ctx.fillStyle = pal.pupil || '#080830';
                ctx.fillRect(x + 19, sy + by + 11, 2, 2);
                ctx.fillRect(x + 29, sy + by + 11, 2, 2);
                ctx.fillStyle = '#ffffff';
                ctx.fillRect(x + 17, sy + by + 10, D, D);
                ctx.fillRect(x + 27, sy + by + 10, D, D);
                ctx.globalAlpha = 0.5;
                ctx.fillRect(x + 20, sy + by + 12, D, D);
                ctx.fillRect(x + 30, sy + by + 12, D, D);
                ctx.globalAlpha = 1;
                ctx.fillStyle = pal.eyeLash || pal.outline;
                ctx.fillRect(x + 16, sy + by + 9, 2, D);
                ctx.fillRect(x + 20, sy + by + 9, 2, D);
                ctx.fillRect(x + 26, sy + by + 9, 2, D);
                ctx.fillRect(x + 30, sy + by + 9, 2, D);
                ctx.fillStyle = pal.nose || pal.skinSh;
                ctx.fillRect(x + 22, sy + by + 14, 4, 2);
                ctx.fillStyle = pal.skinDk || pal.skinSh;
                ctx.fillRect(x + 23, sy + by + 15, 2, D);
                ctx.fillStyle = pal.mouth || pal.skinSh;
                ctx.fillRect(x + 21, sy + by + 17, 6, D);
                ctx.fillStyle = pal.skinHL || pal.skin;
                ctx.fillRect(x + 22, sy + by + 17, 4, D);
                if (pal.cheek) {
                    ctx.fillStyle = pal.cheek;
                    ctx.globalAlpha = 0.3;
                    ctx.beginPath();
                    ctx.ellipse(x + 16, sy + by + 14, 3, 2, 0, 0, Math.PI * 2);
                    ctx.fill();
                    ctx.beginPath();
                    ctx.ellipse(x + 32, sy + by + 14, 3, 2, 0, 0, Math.PI * 2);
                    ctx.fill();
                    ctx.globalAlpha = 1;
                }
                ctx.fillStyle = pal.skin;
                ctx.fillRect(x + 20, sy + by + 19, 8, 3);
                ctx.fillStyle = pal.outline;
                ctx.fillRect(x + 18, sy + by + 20, 12, D);
                ctx.fillStyle = pal.collar || pal.tunicHL;
                ctx.fillRect(x + 14, sy + by + 22, 20, 3);
                ctx.fillStyle = pal.collarSh || pal.tunic;
                ctx.fillRect(x + 18, sy + by + 23, 12, 2);
                ctx.fillRect(x + 22, sy + by + 22, 4, 3);
                ctx.fillStyle = pal.shoulder || pal.tunic;
                ctx.beginPath();
                ctx.ellipse(x + 7, sy + by + 27, 6, 5, 0, 0, Math.PI * 2);
                ctx.fill();
                ctx.beginPath();
                ctx.ellipse(x + 41, sy + by + 27, 6, 5, 0, 0, Math.PI * 2);
                ctx.fill();
                ctx.fillStyle = pal.shoulderHL || pal.tunicHL;
                ctx.fillRect(x + 4, sy + by + 25, 6, 2);
                ctx.fillRect(x + 38, sy + by + 25, 6, 2);
                ctx.fillStyle = pal.tunic;
                ctx.fillRect(x + 10, sy + by + 25, 28, 18);
                ctx.fillStyle = pal.tunicHL;
                ctx.fillRect(x + 12, sy + by + 25, 12, 14);
                ctx.fillStyle = pal.tunicMd || pal.tunic;
                ctx.fillRect(x + 24, sy + by + 25, 12, 14);
                ctx.fillStyle = pal.tunicDk;
                ctx.fillRect(x + 10, sy + by + 41, 28, 2);
                ctx.fillStyle = pal.tunicSh || pal.tunicDk;
                ctx.fillRect(x + 23, sy + by + 25, 2, 18);
                ctx.fillStyle = pal.tunicDk;
                for (let i = 0; i < 4; i++) ctx.fillRect(x + 14 + i * 4, sy + by + 30, D, 8);
                ctx.fillRect(x + 16, sy + by + 28, 8, D);
                ctx.fillRect(x + 28, sy + by + 32, 6, D);
                ctx.fillStyle = pal.tunicTrim || pal.tunicHL;
                ctx.fillRect(x + 10, sy + by + 42, 28, D);
                ctx.fillStyle = pal.tunicTrimDk || pal.tunicDk;
                ctx.fillRect(x + 10, sy + by + 43, 28, D);
                if (hasApron) {
                    ctx.fillStyle = pal.apron || '#e0d0b0';
                    ctx.fillRect(x + 14, sy + by + 34, 20, 10);
                    ctx.fillStyle = pal.apronSh || '#c0b090';
                    ctx.fillRect(x + 14, sy + by + 42, 20, 2);
                    ctx.fillStyle = pal.apronHL || '#f0e0c0';
                    ctx.fillRect(x + 16, sy + by + 34, 16, D);
                    ctx.fillStyle = pal.apron || '#e0d0b0';
                    ctx.fillRect(x + 22, sy + by + 32, 4, 2);
                }
                ctx.fillStyle = pal.belt;
                ctx.fillRect(x + 10, sy + by + 44, 28, 4);
                ctx.fillStyle = pal.beltHL || pal.belt;
                ctx.fillRect(x + 12, sy + by + 44, 12, D);
                ctx.fillStyle = pal.beltBk;
                ctx.fillRect(x + 22, sy + by + 44, 5, 4);
                ctx.fillStyle = '#fff';
                ctx.globalAlpha = 0.5;
                ctx.fillRect(x + 23, sy + by + 44, 2, D);
                ctx.globalAlpha = 0.25;
                ctx.fillRect(x + 24, sy + by + 45, D, D);
                ctx.globalAlpha = 1;
                if (isHero) {
                    ctx.fillStyle = pal.weapon || '#a0a8b8';
                    ctx.fillRect(x + 3, sy + by + 36, 3, 14);
                    ctx.fillStyle = pal.weaponHL || '#d0d8e0';
                    ctx.fillRect(x + 3, sy + by + 36, D, 12);
                    ctx.fillStyle = pal.weaponDk || '#606878';
                    ctx.fillRect(x + 5, sy + by + 37, D, 12);
                    ctx.fillStyle = '#c0a040';
                    ctx.fillRect(x + 2, sy + by + 36, 5, 2);
                    ctx.fillStyle = '#e0c060';
                    ctx.fillRect(x + 3, sy + by + 36, 3, D);
                }
                ctx.fillStyle = pal.glove || pal.skin;
                const laX = Math.round(2 + armL * 1.3);
                const raX = Math.round(40 + armR * 1.3);
                ctx.fillRect(x + laX, sy + by + 26, 6, 18);
                ctx.fillRect(x + raX, sy + by + 26, 6, 18);
                ctx.fillStyle = pal.tunic;
                ctx.fillRect(x + laX, sy + by + 26, 6, 6);
                ctx.fillRect(x + raX, sy + by + 26, 6, 6);
                ctx.fillStyle = pal.tunicDk;
                ctx.fillRect(x + laX, sy + by + 32, 6, 2);
                ctx.fillRect(x + raX, sy + by + 32, 6, 2);
                ctx.fillStyle = pal.skin;
                ctx.fillRect(x + laX + 1, sy + by + 34, 5, 5);
                ctx.fillRect(x + raX + 1, sy + by + 34, 5, 5);
                ctx.fillStyle = pal.gloveCuff || pal.gloveSh || pal.skinSh;
                ctx.fillRect(x + laX, sy + by + 39, 6, 2);
                ctx.fillRect(x + raX, sy + by + 39, 6, 2);
                ctx.fillStyle = pal.glove || pal.skin;
                ctx.fillRect(x + laX, sy + by + 39, 6, 5);
                ctx.fillStyle = pal.gloveSh || pal.skinSh;
                ctx.fillRect(x + laX, sy + by + 42, 6, 2);
                ctx.fillRect(x + raX, sy + by + 42, 6, 2);
                ctx.fillStyle = pal.pants;
                ctx.fillRect(x + 12, y + 2, 11, 14);
                ctx.fillRect(x + 25, y + 2, 11, 14);
                ctx.fillStyle = pal.pantsHL || pal.pants;
                ctx.fillRect(x + 14, y + 2, 5, 8);
                ctx.fillRect(x + 29, y + 2, 5, 8);
                ctx.fillStyle = pal.pantsDk;
                ctx.fillRect(x + 23, y + 2, 4, 14);
                ctx.fillStyle = pal.pantsSeam || pal.pantsDk;
                ctx.fillRect(x + 17, y + 4, D, 10);
                ctx.fillRect(x + 31, y + 4, D, 10);
                ctx.fillStyle = pal.pantsDk;
                ctx.fillRect(x + 12, y + 10, 11, 2);
                ctx.fillRect(x + 25, y + 10, 11, 2);
                ctx.fillRect(x + 14, y + 14, 9, 2);
                ctx.fillRect(x + 27, y + 14, 9, 2);
                ctx.fillStyle = pal.boots;
                ctx.fillRect(x + 11, y + 16 + legL, 12, 24);
                ctx.fillRect(x + 25, y + 16 + legR, 12, 24);
                ctx.fillStyle = pal.bootsCuff || pal.bootsHL;
                ctx.beginPath();
                ctx.ellipse(x + 17, y + 17 + legL, 7, 3, 0, 0, Math.PI * 2);
                ctx.fill();
                ctx.beginPath();
                ctx.ellipse(x + 31, y + 17 + legR, 7, 3, 0, 0, Math.PI * 2);
                ctx.fill();
                ctx.fillStyle = pal.bootsHL;
                ctx.fillRect(x + 13, y + 18 + legL, 5, D);
                ctx.fillRect(x + 27, y + 18 + legR, 5, D);
                ctx.fillStyle = pal.bootsDk || pal.boots;
                ctx.fillRect(x + 11, y + 36 + legL, 12, 2);
                ctx.fillRect(x + 25, y + 36 + legR, 12, 2);
                ctx.fillStyle = pal.bootsSh || pal.bootsDk || pal.boots;
                ctx.fillRect(x + 14, y + 28 + legL, D, 4);
                ctx.fillRect(x + 28, y + 28 + legR, D, 4);
                ctx.fillStyle = pal.bootsHL;
                ctx.fillRect(x + 16, y + 24 + legL, D, D);
                ctx.fillRect(x + 16, y + 30 + legL, D, D);
                ctx.fillRect(x + 30, y + 24 + legR, D, D);
                ctx.fillRect(x + 30, y + 30 + legR, D, D);
                ctx.fillStyle = pal.bootsSole || pal.bootsDk || pal.boots;
                ctx.fillRect(x + 10, y + 40 + legL, 14, 8);
                ctx.fillRect(x + 24, y + 40 + legR, 14, 8);
                ctx.fillStyle = pal.bootsDk || pal.boots;
                ctx.fillRect(x + 10, y + 44 + legL, 14, 4);
                ctx.fillRect(x + 24, y + 44 + legR, 14, 4);
                break;
            }
            case 'up': {
                ctx.fillStyle = pal.outline;
                ...
                if (hasHat) {
                    ...
                    ctx.fillStyle = pal.hairDk || pal.hair;
                    ctx.beginPath();
                    ctx.ellipse(x + 24, sy + by + 4, 13, 9, 0, 0, Math.PI * 2);
                    ctx.fill();
                    ctx.fillStyle = pal.hair;
                    ctx.beginPath();
                    ctx.ellipse(x + 24, sy + by + 7, 12, 10, 0, 0, Math.PI * 2);
                    ctx.fill();
                    ctx.fillStyle = pal.hairHL;
                    ctx.beginPath();
                    ctx.ellipse(x + 22, sy + by + 5, 7, 5, 0, 0, Math.PI * 2);
                    ctx.fill();
                    ctx.fillStyle = pal.hairMd || pal.hair;
                    ctx.fillRect(x + 12, sy + by + 12, 24, 5);
                    ctx.fillStyle = pal.hairDk || pal.hair;
                    ctx.fillRect(x + 14, sy + by + 15, 20, 5);
                    if (isHero) {
                        ctx.fillStyle = pal.hair;
                        ctx.fillRect(x + 10, sy + by + 3, 4, 9);
                        ctx.fillRect(x + 34, sy + by + 3, 4, 9);
                        ctx.fillStyle = pal.hairDk || pal.hair;
                        ctx.fillRect(x + 15, sy + by - 3, 3, 5);
                        ctx.fillRect(x + 21, sy + by - 5, 3, 7);
                        ctx.fillRect(x + 27, sy + by - 4, 3, 6);
                ...
                if (isHero) {
                    ...
                    ctx.fillRect(x + 7, sy + by + 22, 34, 26);
                    ctx.fillStyle = pal.capeHL || pal.cape;
                    ctx.fillRect(x + 9, sy + by + 22, 12, 22);
                    ctx.fillStyle = pal.capeMd || pal.capeDk;
                    ctx.fillRect(x + 22, sy + by + 22, 3, 26);
                    ctx.fillStyle = pal.capeDk;
                    ctx.fillRect(x + 28, sy + by + 23, 11, 25);
                    ctx.fillStyle = pal.capeEdge || pal.capeDk;
                    ctx.fillRect(x + 7, sy + by + 46, 34, 2);
                    ctx.fillStyle = pal.cape;
                    for (let i = 0; i < 6; i++) ctx.fillRect(x + 10 + i * 5, sy + by + 28, D, 14);
                    const capeWave = moving ? Math.sin(frame * Math.PI / 2) * 3 : Math.sin(gt / 1200) * 0.5;
                    ctx.fillStyle = pal.capeDk;
                    ctx.fillRect(x + 12, sy + by + 46 + Math.round(capeWave), 24, 2);
                    ctx.fillStyle = pal.capeHL || pal.cape;
                    ctx.globalAlpha = 0.3;
                    ctx.fillRect(x + 12, sy + by + 23, 10, 2);
                    ctx.globalAlpha = 1;
                } else {
                    ctx.fillStyle = pal.tunic;
                    ctx.fillRect(x + 10, sy + by + 22, 28, 22);
                    ctx.fillStyle = pal.tunicHL;
                    ctx.fillRect(x + 12, sy + by + 22, 12, 16);
                    ctx.fillStyle = pal.tunicDk;
                    ctx.fillRect(x + 22, sy + by + 22, 3, 22);
                    ctx.fillRect(x + 10, sy + by + 42, 28, 2);
                    ctx.fillStyle = pal.tunicTrim || pal.tunicHL;
                    ctx.fillRect(x + 10, sy + by + 42, 28, D);
                    ctx.fillStyle = pal.tunicDk;
                    for (let i = 0; i < 4; i++) ctx.fillRect(x + 14 + i * 4, sy + by + 28, D, 10);
                }
                ctx.fillStyle = pal.shoulder || pal.tunic;
                ctx.beginPath();
                ctx.ellipse(x + 7, sy + by + 27, 6, 5, 0, 0, Math.PI * 2);
                ...
                ctx.fillRect(x + 10, sy + by + 44, 28, 4);
                ctx.fillStyle = pal.beltHL || pal.belt;
                ctx.fillRect(x + 14, sy + by + 44, 20, D);
                ctx.fillStyle = pal.skin;
                const ulaX = Math.round(2 + armL * 1.3);
                const uraX = Math.round(40 + armR * 1.3);
                ctx.fillRect(x + ulaX, sy + by + 26, 6, 16);
                ctx.fillRect(x + uraX, sy + by + 26, 6, 16);
                ctx.fillStyle = pal.tunic;
                ctx.fillRect(x + ulaX, sy + by + 26, 6, 6);
                ctx.fillRect(x + uraX, sy + by + 26, 6, 6);
                ctx.fillStyle = pal.gloveCuff || pal.gloveSh || pal.skinSh;
                ctx.fillRect(x + ulaX, sy + by + 38, 6, 2);
                ctx.fillRect(x + uraX, sy + by + 38, 6, 2);
                ctx.fillStyle = pal.skinSh;
                ctx.fillRect(x + ulaX, sy + by + 40, 6, 2);
                ctx.fillRect(x + uraX, sy + by + 40, 6, 2);
                ctx.fillStyle = pal.pants;
                ctx.fillRect(x + 12, y + 2, 11, 14);
                ctx.fillRect(x + 25, y + 2, 11, 14);
                ctx.fillStyle = pal.pantsDk;
            ...
            case 'left': {
                ctx.fillStyle = pal.outline;
                ctx.beginPath();
                ctx.ellipse(x + 20, sy + by + 10, 11, 10, 0, 0, Math.PI * 2);
                ctx.fill();
                if (hasHat) {
                    ctx.fillStyle = pal.hat || pal.hair;
                    ctx.beginPath();
                    ctx.ellipse(x + 18, sy + by + 3, 14, 7, 0, 0, Math.PI * 2);
                    ctx.fill();
                    ctx.fillStyle = pal.hatHL || pal.hairHL;
                    ctx.beginPath();
                    ctx.ellipse(x + 16, sy + by + 2, 9, 4, 0, 0, Math.PI * 2);
                    ctx.fill();
                    ctx.fillStyle = pal.hatDk || pal.hairDk;
                    ctx.fillRect(x + 6, sy + by + 5, 26, 3);
                } else {
                    ctx.fillStyle = pal.hairDk || pal.hair;
                    ctx.beginPath();
                    ctx.ellipse(x + 20, sy + by + 4, 12, 8, 0, 0, Math.PI * 2);
                    ctx.fill();
                    ctx.fillStyle = pal.hair;
                    ctx.beginPath();
                    ctx.ellipse(x + 20, sy + by + 6, 11, 7, 0, 0, Math.PI * 2);
                    ctx.fill();
                    ctx.fillStyle = pal.hairHL;
                    ctx.beginPath();
                    ctx.ellipse(x + 18, sy + by + 4, 7, 4, 0, 0, Math.PI * 2);
                    ctx.fill();
                    ctx.fillStyle = pal.hairMd || pal.hair;
                    ctx.fillRect(x + 8, sy + by + 9, 22, 3);
                    ctx.fillStyle = pal.hair;
                    ctx.fillRect(x + 6, sy + by + 10, 10, 8);
                    if (isHero) {
                        ctx.fillStyle = pal.hairDk || pal.hair;
                        ctx.fillRect(x + 12, sy + by - 3, 3, 5);
                        ctx.fillRect(x + 18, sy + by - 4, 3, 6);
                        ctx.fillRect(x + 24, sy + by - 2, 3, 4);
                    }
                }
                ctx.fillStyle = pal.skin;
                ctx.beginPath();
                ctx.ellipse(x + 20, sy + by + 13, 9, 7, 0, 0, Math.PI * 2);
                ctx.fill();
                ctx.fillStyle = pal.skinHL || pal.skin;
                ctx.beginPath();
                ctx.ellipse(x + 18, sy + by + 11, 5, 3, 0, 0, Math.PI * 2);
                ctx.fill();
                ctx.fillStyle = pal.skinSh;
                ctx.fillRect(x + 12, sy + by + 16, 16, 2);
                ctx.fillStyle = pal.skin;
                ctx.fillRect(x + 10, sy + by + 12, 3, 4);
                ctx.fillStyle = pal.skinSh;
                ctx.fillRect(x + 10, sy + by + 13, 2, D);
                ctx.fillStyle = pal.eyeW || '#f0f0ff';
                ctx.fillRect(x + 13, sy + by + 10, 6, 4);
                ctx.fillStyle = pal.outline;
                ctx.fillRect(x + 13, sy + by + 9, 6, D);
                ctx.fillRect(x + 12, sy + by + 10, D, 4);
                ctx.fillRect(x + 19, sy + by + 10, D, 4);
                ctx.fillRect(x + 13, sy + by + 14, 6, D);
                ctx.fillStyle = pal.eye;
                ctx.fillRect(x + 14, sy + by + 10, 4, 3);
                ctx.fillStyle = pal.eyeHL || '#4060d0';
                ctx.fillRect(x + 15, sy + by + 10, 2, 2);
                ctx.fillStyle = pal.pupil || '#080830';
                ctx.fillRect(x + 14, sy + by + 11, 2, 2);
                ctx.fillStyle = '#ffffff';
                ctx.fillRect(x + 16, sy + by + 10, D, D);
                ctx.fillStyle = pal.nose || pal.skinSh;
                ctx.fillRect(x + 11, sy + by + 14, 2, 2);
                ctx.fillStyle = pal.mouth || pal.skinSh;
                ctx.fillRect(x + 14, sy + by + 17, 5, D);
                ctx.fillStyle = pal.skin;
                ctx.fillRect(x + 18, sy + by + 19, 6, 3);
                ctx.fillStyle = pal.outline;
                ctx.fillRect(x + 16, sy + by + 20, 8, D);
                ctx.fillStyle = pal.collar || pal.tunicHL;
                ctx.fillRect(x + 12, sy + by + 22, 18, 3);
                ctx.fillStyle = pal.collarSh || pal.tunic;
                ctx.fillRect(x + 14, sy + by + 23, 14, 2);
                ctx.fillStyle = pal.shoulder || pal.tunic;
                ctx.beginPath();
                ctx.ellipse(x + 7, sy + by + 27, 6, 5, 0, 0, Math.PI * 2);
                ctx.fill();
                ctx.fillStyle = pal.tunic;
                ctx.fillRect(x + 10, sy + by + 25, 22, 18);
                ctx.fillStyle = pal.tunicHL;
                ctx.fillRect(x + 12, sy + by + 25, 10, 14);
                ctx.fillStyle = pal.tunicDk;
                ctx.fillRect(x + 26, sy + by + 25, 6, 18);
                ctx.fillRect(x + 10, sy + by + 41, 22, 2);
                ctx.fillStyle = pal.tunicTrim || pal.tunicHL;
                ctx.fillRect(x + 10, sy + by + 42, 22, D);
                ctx.fillStyle = pal.tunicDk;
                for (let i = 0; i < 3; i++) ctx.fillRect(x + 14 + i * 4, sy + by + 30, D, 8);
                ctx.fillRect(x + 16, sy + by + 28, 6, D);
                if (hasApron) {
                    ctx.fillStyle = pal.apron || '#e0d0b0';
                    ctx.fillRect(x + 12, sy + by + 34, 18, 10);
                    ctx.fillStyle = pal.apronSh || '#c0b090';
                    ctx.fillRect(x + 12, sy + by + 42, 18, 2);
                }
                ctx.fillStyle = pal.belt;
                ctx.fillRect(x + 10, sy + by + 44, 22, 4);
                ctx.fillStyle = pal.beltHL || pal.belt;
                ctx.fillRect(x + 14, sy + by + 44, 8, D);
                ctx.fillStyle = pal.beltBk;
                ctx.fillRect(x + 22, sy + by + 44, 4, 4);
                ctx.fillStyle = '#fff';
                ctx.globalAlpha = 0.4;
                ctx.fillRect(x + 22, sy + by + 44, 2, D);
                ctx.globalAlpha = 1;
                if (isHero) {
                    ctx.fillStyle = pal.weapon || '#a0a8b8';
                    ctx.fillRect(x + 30, sy + by + 24, 3, 22);
                    ctx.fillStyle = pal.weaponHL || '#d0d8e0';
                    ctx.fillRect(x + 30, sy + by + 24, D, 20);
                    ctx.fillStyle = pal.weaponDk || '#606878';
                    ctx.fillRect(x + 32, sy + by + 25, D, 20);
                    ctx.fillStyle = '#c0a040';
                    ctx.fillRect(x + 29, sy + by + 44, 5, 2);
                }
                ctx.fillStyle = pal.glove || pal.skin;
                const llaX = Math.round(2 + armL * 1.3);
                ctx.fillRect(x + llaX, sy + by + 26, 6, 18);
                ctx.fillStyle = pal.tunic;
                ctx.fillRect(x + llaX, sy + by + 26, 6, 6);
                ctx.fillStyle = pal.tunicDk;
                ctx.fillRect(x + llaX, sy + by + 32, 6, 2);
                ctx.fillStyle = pal.skin;
                ctx.fillRect(x + llaX + 1, sy + by + 34, 5, 5);
                ctx.fillStyle = pal.gloveCuff || pal.gloveSh || pal.skinSh;
                ctx.fillRect(x + llaX, sy + by + 39, 6, 2);
                ctx.fillStyle = pal.gloveSh || pal.skinSh;
                ctx.fillRect(x + llaX, sy + by + 42, 6, 2);
                ctx.fillStyle = pal.skin;
                ctx.fillRect(x + llaX + 1, sy + by + 42, 4, 2);
                ctx.fillStyle = pal.pants;
                ctx.fillRect(x + 12, y + 2, 18, 14);
                ctx.fillStyle = pal.pantsDk;
                ctx.fillRect(x + 12, y + 2, 6, 14);
                ctx.fillRect(x + 12, y + 10, 18, 2);
                ctx.fillRect(x + 14, y + 14, 16, 2);
                ctx.fillStyle = pal.pantsHL || pal.pants;
                ctx.fillRect(x + 22, y + 2, 5, 8);
                ctx.fillStyle = pal.pantsSeam || pal.pantsDk;
                ctx.fillRect(x + 20, y + 4, D, 10);
                ctx.fillStyle = pal.boots;
                ctx.fillRect(x + 10, y + 16 + legL, 12, 24);
                ctx.fillRect(x + 24, y + 16 + legR, 12, 24);
                ctx.fillStyle = pal.bootsCuff || pal.bootsHL;
                ctx.beginPath();
                ctx.ellipse(x + 16, y + 17 + legL, 7, 3, 0, 0, Math.PI * 2);
                ctx.fill();
                ctx.beginPath();
                ctx.ellipse(x + 30, y + 17 + legR, 7, 3, 0, 0, Math.PI * 2);
                ctx.fill();
                ctx.fillStyle = pal.bootsDk || pal.boots;
                ctx.fillRect(x + 10, y + 36 + legL, 12, 2);
                ctx.fillRect(x + 24, y + 36 + legR, 12, 2);
                ctx.fillStyle = pal.bootsSole || pal.bootsDk || pal.boots;
                ctx.fillRect(x + 9, y + 40 + legL, 14, 8);
                ctx.fillRect(x + 23, y + 40 + legR, 14, 8);
                ctx.fillStyle = pal.bootsHL;
                ctx.fillRect(x + 14, y + 24 + legL, D, D);
                ctx.fillRect(x + 14, y + 30 + legL, D, D);
                ctx.fillRect(x + 28, y + 24 + legR, D, D);
                ctx.fillStyle = pal.bootsDk || pal.boots;
                ctx.fillRect(x + 9, y + 44 + legL, 14, 4);
                ctx.fillRect(x + 23, y + 44 + legR, 14, 4);
                break;
            }
            case 'right': {
                ctx.fillStyle = pal.outline;
                ctx.beginPath();
                ctx.ellipse(x + 28, sy + by + 10, 11, 10, 0, 0, Math.PI * 2);
                ctx.fill();
                if (hasHat) {
                    ctx.fillStyle = pal.hat || pal.hair;
                    ctx.beginPath();
                    ctx.ellipse(x + 30, sy + by + 3, 14, 7, 0, 0, Math.PI * 2);
                    ctx.fill();
                    ctx.fillStyle = pal.hatHL || pal.hairHL;
                    ctx.beginPath();
                    ctx.ellipse(x + 32, sy + by + 2, 9, 4, 0, 0, Math.PI * 2);
                    ctx.fill();
                    ctx.fillStyle = pal.hatDk || pal.hairDk;
                    ctx.fillRect(x + 16, sy + by + 5, 26, 3);
                } else {
                    ctx.fillStyle = pal.hairDk || pal.hair;
                    ctx.beginPath();
                    ctx.ellipse(x + 28, sy + by + 4, 12, 8, 0, 0, Math.PI * 2);
                    ctx.fill();
                    ctx.fillStyle = pal.hair;
                    ctx.beginPath();
                    ctx.ellipse(x + 28, sy + by + 6, 11, 7, 0, 0, Math.PI * 2);
                    ctx.fill();
                    ctx.fillStyle = pal.hairHL;
                    ctx.beginPath();
                    ctx.ellipse(x + 30, sy + by + 4, 7, 4, 0, 0, Math.PI * 2);
                    ctx.fill();
                    ctx.fillStyle = pal.hairMd || pal.hair;
                    ctx.fillRect(x + 18, sy + by + 9, 22, 3);
                    ctx.fillStyle = pal.hair;
                    ctx.fillRect(x + 32, sy + by + 10, 10, 8);
                    if (isHero) {
                        ctx.fillStyle = pal.hairDk || pal.hair;
                        ctx.fillRect(x + 22, sy + by - 2, 3, 4);
                        ctx.fillRect(x + 28, sy + by - 4, 3, 6);
                        ctx.fillRect(x + 34, sy + by - 3, 3, 5);
                    }
                }
                ctx.fillStyle = pal.skin;
                ctx.beginPath();
                ctx.ellipse(x + 28, sy + by + 13, 9, 7, 0, 0, Math.PI * 2);
                ctx.fill();
                ctx.fillStyle = pal.skinHL || pal.skin;
                ctx.beginPath();
                ctx.ellipse(x + 30, sy + by + 11, 5, 3, 0, 0, Math.PI * 2);
                ctx.fill();
                ctx.fillStyle = pal.skinSh;
                ctx.fillRect(x + 20, sy + by + 16, 16, 2);
                ctx.fillStyle = pal.skin;
                ctx.fillRect(x + 35, sy + by + 12, 3, 4);
                ctx.fillStyle = pal.skinSh;
                ctx.fillRect(x + 36, sy + by + 13, 2, D);
                ctx.fillStyle = pal.eyeW || '#f0f0ff';
                ctx.fillRect(x + 29, sy + by + 10, 6, 4);
                ctx.fillStyle = pal.outline;
                ctx.fillRect(x + 29, sy + by + 9, 6, D);
                ctx.fillRect(x + 28, sy + by + 10, D, 4);
                ctx.fillRect(x + 35, sy + by + 10, D, 4);
                ctx.fillRect(x + 29, sy + by + 14, 6, D);
                ctx.fillStyle = pal.eye;
                ctx.fillRect(x + 30, sy + by + 10, 4, 3);
                ctx.fillStyle = pal.eyeHL || '#4060d0';
                ctx.fillRect(x + 31, sy + by + 10, 2, 2);
                ctx.fillStyle = pal.pupil || '#080830';
                ctx.fillRect(x + 32, sy + by + 11, 2, 2);
                ctx.fillStyle = '#ffffff';
                ctx.fillRect(x + 31, sy + by + 10, D, D);
                ctx.fillStyle = pal.nose || pal.skinSh;
                ctx.fillRect(x + 35, sy + by + 14, 2, 2);
                ctx.fillStyle = pal.mouth || pal.skinSh;
                ctx.fillRect(x + 29, sy + by + 17, 5, D);
                ctx.fillStyle = pal.skin;
                ctx.fillRect(x + 24, sy + by + 19, 6, 3);
                ctx.fillStyle = pal.outline;
                ctx.fillRect(x + 24, sy + by + 20, 8, D);
                ctx.fillStyle = pal.collar || pal.tunicHL;
                ctx.fillRect(x + 18, sy + by + 22, 18, 3);
                ctx.fillStyle = pal.collarSh || pal.tunic;
                ctx.fillRect(x + 20, sy + by + 23, 14, 2);
                ctx.fillStyle = pal.shoulder || pal.tunic;
                ctx.beginPath();
                ctx.ellipse(x + 41, sy + by + 27, 6, 5, 0, 0, Math.PI * 2);
                ctx.fill();
                ctx.fillStyle = pal.tunic;
                ctx.fillRect(x + 16, sy + by + 25, 22, 18);
                ctx.fillStyle = pal.tunicHL;
                ctx.fillRect(x + 26, sy + by + 25, 10, 14);
                ctx.fillStyle = pal.tunicDk;
                ctx.fillRect(x + 16, sy + by + 25, 6, 18);
                ctx.fillRect(x + 16, sy + by + 41, 22, 2);
                ctx.fillStyle = pal.tunicTrim || pal.tunicHL;
                ctx.fillRect(x + 16, sy + by + 42, 22, D);
                ctx.fillStyle = pal.tunicDk;
                for (let i = 0; i < 3; i++) ctx.fillRect(x + 27 + i * 4, sy + by + 30, D, 8);
                ctx.fillRect(x + 27, sy + by + 28, 6, D);
                if (hasApron) {
                    ctx.fillStyle = pal.apron || '#e0d0b0';
                    ctx.fillRect(x + 18, sy + by + 34, 18, 10);
                    ctx.fillStyle = pal.apronSh || '#c0b090';
                    ctx.fillRect(x + 18, sy + by + 42, 18, 2);
                }
                ctx.fillStyle = pal.belt;
                ctx.fillRect(x + 16, sy + by + 44, 22, 4);
                ctx.fillStyle = pal.beltHL || pal.belt;
                ctx.fillRect(x + 28, sy + by + 44, 8, D);
                ctx.fillStyle = pal.beltBk;
                ctx.fillRect(x + 22, sy + by + 44, 4, 4);
                ctx.fillStyle = '#fff';
                ctx.globalAlpha = 0.4;
                ctx.fillRect(x + 24, sy + by + 44, 2, D);
                ctx.globalAlpha = 1;
                if (isHero) {
                    ctx.fillStyle = pal.weapon || '#a0a8b8';
                    ctx.fillRect(x + 14, sy + by + 24, 3, 22);
                    ctx.fillStyle = pal.weaponHL || '#d0d8e0';
                    ctx.fillRect(x + 16, sy + by + 24, D, 20);
                    ctx.fillStyle = pal.weaponDk || '#606878';
                    ctx.fillRect(x + 14, sy + by + 25, D, 20);
                    ctx.fillStyle = '#c0a040';
                    ctx.fillRect(x + 13, sy + by + 44, 5, 2);
                }
                ctx.fillStyle = pal.glove || pal.skin;
                const rraX = Math.round(40 + armR * 1.3);
                ctx.fillRect(x + rraX, sy + by + 26, 6, 18);
                ctx.fillStyle = pal.tunic;
                ctx.fillRect(x + rraX, sy + by + 26, 6, 6);
                ctx.fillStyle = pal.tunicDk;
                ctx.fillRect(x + rraX, sy + by + 32, 6, 2);
                ctx.fillStyle = pal.skin;
                ctx.fillRect(x + rraX + 1, sy + by + 34, 5, 5);
                ctx.fillStyle = pal.gloveCuff || pal.gloveSh || pal.skinSh;
                ctx.fillRect(x + rraX, sy + by + 39, 6, 2);
                ctx.fillStyle = pal.gloveSh || pal.skinSh;
                ctx.fillRect(x + rraX, sy + by + 42, 6, 2);
                ctx.fillStyle = pal.skin;
                ctx.fillRect(x + rraX + 1, sy + by + 42, 4, 2);
                ctx.fillStyle = pal.pants;
                ctx.fillRect(x + 18, y + 2, 18, 14);
                ctx.fillStyle = pal.pantsDk;
                ctx.fillRect(x + 30, y + 2, 6, 14);
                ctx.fillRect(x + 18, y + 10, 18, 2);
                ctx.fillRect(x + 18, y + 14, 16, 2);
                ctx.fillStyle = pal.pantsHL || pal.pants;
                ctx.fillRect(x + 22, y + 2, 5, 8);
                ctx.fillStyle = pal.pantsSeam || pal.pantsDk;
                ctx.fillRect(x + 27, y + 4, D, 10);
                ctx.fillStyle = pal.boots;
                ctx.fillRect(x + 16, y + 16 + legL, 12, 24);
                ctx.fillRect(x + 28, y + 16 + legR, 12, 24);
                ctx.fillStyle = pal.bootsCuff || pal.bootsHL;
                ctx.beginPath();
                ctx.ellipse(x + 22, y + 17 + legL, 7, 3, 0, 0, Math.PI * 2);
                ctx.fill();
                ctx.beginPath();
                ctx.ellipse(x + 34, y + 17 + legR, 7, 3, 0, 0, Math.PI * 2);
                ctx.fill();
                ctx.fillStyle = pal.bootsDk || pal.boots;
                ctx.fillRect(x + 16, y + 36 + legL, 12, 2);
                ctx.fillRect(x + 28, y + 36 + legR, 12, 2);
                ctx.fillStyle = pal.bootsSole || pal.bootsDk || pal.boots;
                ctx.fillRect(x + 15, y + 40 + legL, 14, 8);
                ctx.fillRect(x + 27, y + 40 + legR, 14, 8);
                ctx.fillStyle = pal.bootsHL;
                ctx.fillRect(x + 20, y + 24 + legL, D, D);
                ctx.fillRect(x + 20, y + 30 + legL, D, D);
                ctx.fillRect(x + 32, y + 24 + legR, D, D);
                ctx.fillStyle = pal.bootsDk || pal.boots;
                ctx.fillRect(x + 15, y + 44 + legL, 14, 4);
                ctx.fillRect(x + 27, y + 44 + legR, 14, 4);
                break;
            }
        }
    }
