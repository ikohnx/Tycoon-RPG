        ...
        switch(facing) {
            case 'down': {
                if (hasHat) {
                    ...
                    ell(cx-1, sy+by+3, 7, 4);
                    ctx.fillStyle = pal.hatDk || pal.hairDk;
                    ctx.fillRect(cx-9, sy+by+6, 18, 2);
                } else {
                    ...
                    ell(cx-2, sy+by+4, 4, 3);
                    ctx.fillStyle = pal.hairMd || pal.hair;
                    ctx.fillRect(cx-7, sy+by+9, 14, 2);
                    if (isHero) {
                        ctx.fillStyle = pal.hair;
                        ctx.fillRect(cx-8, sy+by+3, 3, 6);
                        ctx.fillRect(cx+5, sy+by+3, 3, 6);
                        ctx.fillStyle = pal.hairDk;
                        ctx.fillRect(cx-4, sy+by-2, 2, 4);
                        ctx.fillRect(cx-1, sy+by-4, 2, 5);
                        ctx.fillRect(cx+3, sy+by-3, 2, 4);
                        ctx.fillStyle = pal.hairHL;
                        ctx.fillRect(cx-3, sy+by-1, D, 3);
                        ctx.fillRect(cx+1, sy+by-3, D, 3);
                    }
                }
                ctx.fillStyle = pal.skin;
                ell(cx, sy+by+12, 7, 6);
                ctx.fillStyle = pal.skinHL;
                ell(cx-1, sy+by+10, 4, 3);
                ctx.fillStyle = pal.skinSh;
                ctx.fillRect(cx-5, sy+by+16, 10, D);
                ctx.fillStyle = pal.eyeW;
                ctx.fillRect(cx-5, sy+by+10, 3, 3);
                ctx.fillRect(cx+2, sy+by+10, 3, 3);
                ctx.fillStyle = pal.eye;
                ctx.fillRect(cx-4, sy+by+10, 2, 2);
                ctx.fillRect(cx+3, sy+by+10, 2, 2);
                ctx.fillStyle = pal.pupil || '#080830';
                ctx.fillRect(cx-4, sy+by+11, D, D);
                ctx.fillRect(cx+3, sy+by+11, D, D);
                ctx.fillStyle = '#fff';
                ctx.fillRect(cx-3, sy+by+10, D, D);
                ctx.fillRect(cx+4, sy+by+10, D, D);
                ctx.fillStyle = pal.outline;
                ctx.fillRect(cx-5, sy+by+9, 3, D);
                ctx.fillRect(cx+2, sy+by+9, 3, D);
                ctx.fillStyle = pal.nose || pal.skinSh;
                ctx.fillRect(cx-1, sy+by+13, 2, D);
                ctx.fillStyle = pal.mouth || pal.skinSh;
                ctx.fillRect(cx-1, sy+by+15, 3, D);
                if (pal.cheek) {
                    ctx.fillStyle = pal.cheek;
                    ctx.globalAlpha = 0.25;
                    ctx.fillRect(cx-6, sy+by+13, 2, 2);
                    ctx.fillRect(cx+4, sy+by+13, 2, 2);
                    ctx.globalAlpha = 1;
                }
                ctx.fillStyle = pal.skin;
                ctx.fillRect(cx-3, sy+by+17, 6, 3);
                ctx.fillStyle = pal.skinSh;
                ctx.fillRect(cx-3, sy+by+18, 6, D);
                ctx.fillStyle = pal.collar || pal.tunicHL;
                ctx.fillRect(cx-7, sy+by+20, 14, 2);
                ctx.fillStyle = pal.collarSh || pal.tunic;
                ctx.fillRect(cx-2, sy+by+20, 4, 2);
                ctx.fillStyle = pal.shoulder || pal.tunic;
                ell(cx-9, sy+by+24, 3, 3);
                ell(cx+9, sy+by+24, 3, 3);
                ctx.fillStyle = pal.shoulderHL || pal.tunicHL;
                ctx.fillRect(cx-11, sy+by+22, 3, D);
                ctx.fillRect(cx+8, sy+by+22, 3, D);
                ctx.fillStyle = pal.tunic;
                ctx.fillRect(cx-8, sy+by+22, 16, 16);
                ctx.fillStyle = pal.tunicHL;
                ctx.fillRect(cx-6, sy+by+22, 6, 12);
                ctx.fillStyle = pal.tunicMd || pal.tunic;
                ctx.fillRect(cx+1, sy+by+22, 6, 12);
                ctx.fillStyle = pal.tunicDk;
                ctx.fillRect(cx, sy+by+22, D, 16);
                ctx.fillRect(cx-8, sy+by+36, 16, 2);
                ctx.fillRect(cx-4, sy+by+26, D, 8);
                ctx.fillRect(cx+4, sy+by+28, D, 6);
                ctx.fillStyle = pal.tunicTrim || pal.tunicHL;
                ctx.fillRect(cx-8, sy+by+37, 16, D);
                if (hasApron) {
                    ctx.fillStyle = pal.apron || '#e0d0b0';
                    ctx.fillRect(cx-5, sy+by+30, 10, 8);
                    ctx.fillStyle = pal.apronSh || '#c0b090';
                    ctx.fillRect(cx-5, sy+by+36, 10, 2);
                }
                ctx.fillStyle = pal.belt;
                ctx.fillRect(cx-8, sy+by+38, 16, 3);
                ctx.fillStyle = pal.beltHL;
                ctx.fillRect(cx-6, sy+by+38, 5, D);
                ctx.fillStyle = pal.beltBk;
                ctx.fillRect(cx-1, sy+by+38, 3, 3);
                ctx.fillStyle = '#fff';
                ctx.globalAlpha = 0.4;
                ctx.fillRect(cx, sy+by+38, D, D);
                ctx.globalAlpha = 1;
                const laOff = Math.round(armSwing);
                const raOff = Math.round(-armSwing);
                ctx.fillStyle = pal.tunic;
                ctx.fillRect(cx-12+laOff, sy+by+22, 4, 8);
                ctx.fillRect(cx+8+raOff, sy+by+22, 4, 8);
                ctx.fillStyle = pal.tunicDk;
                ctx.fillRect(cx-12+laOff, sy+by+29, 4, D);
                ctx.fillRect(cx+8+raOff, sy+by+29, 4, D);
                ctx.fillStyle = pal.skin;
                ctx.fillRect(cx-11+laOff, sy+by+30, 3, 4);
                ctx.fillRect(cx+9+raOff, sy+by+30, 3, 4);
                ctx.fillStyle = pal.glove || pal.skinSh;
                ctx.fillRect(cx-11+laOff, sy+by+34, 3, 3);
                ctx.fillRect(cx+9+raOff, sy+by+34, 3, 3);
                if (isHero) {
                    ctx.fillStyle = pal.weapon;
                    ctx.fillRect(cx-13+laOff, sy+by+28, 2, 12);
                    ctx.fillStyle = pal.weaponHL;
                    ctx.fillRect(cx-13+laOff, sy+by+28, D, 10);
                    ctx.fillStyle = '#c0a040';
                    ctx.fillRect(cx-14+laOff, sy+by+28, 4, 2);
                }
                ctx.fillStyle = pal.pants;
                ctx.fillRect(cx-6, y+2, 5, 12);
                ctx.fillRect(cx+1, y+2, 5, 12);
                ctx.fillStyle = pal.pantsHL;
                ctx.fillRect(cx-5, y+2, 3, 8);
                ctx.fillRect(cx+2, y+2, 3, 8);
                ctx.fillStyle = pal.pantsDk;
                ctx.fillRect(cx-1, y+2, 2, 12);
                ctx.fillRect(cx-6, y+10, 5, 2);
                ctx.fillRect(cx+1, y+10, 5, 2);
                ctx.fillStyle = pal.boots;
                ctx.fillRect(cx-7, y+14+legL, 6, 20);
                ctx.fillRect(cx+1, y+14+legR, 6, 20);
                ctx.fillStyle = pal.bootsCuff;
                ctx.fillRect(cx-7, y+14+legL, 6, 2);
                ctx.fillRect(cx+1, y+14+legR, 6, 2);
                ctx.fillStyle = pal.bootsHL;
                ctx.fillRect(cx-5, y+16+legL, 2, D);
                ctx.fillRect(cx+3, y+16+legR, 2, D);
                ctx.fillStyle = pal.bootsDk;
                ctx.fillRect(cx-7, y+28+legL, 6, D);
                ctx.fillRect(cx+1, y+28+legR, 6, D);
                ctx.fillStyle = pal.bootsSole;
                ctx.fillRect(cx-8, y+34+legL, 8, 6);
                ctx.fillRect(cx, y+34+legR, 8, 6);
                ctx.fillStyle = pal.bootsDk;
                ctx.fillRect(cx-8, y+38+legL, 8, 2);
                ctx.fillRect(cx, y+38+legR, 8, 2);
                break;
            }
            case 'up': {
                if (hasHat) {
                    ...
                    ell(cx, sy+by+7, 8, 9);
                    ctx.fillStyle = pal.hairHL;
                    ell(cx-2, sy+by+5, 5, 4);
                    ctx.fillStyle = pal.hairMd || pal.hair;
                    ctx.fillRect(cx-8, sy+by+12, 16, 4);
                    ctx.fillStyle = pal.hairDk;
                    ctx.fillRect(cx-7, sy+by+14, 14, 4);
                    if (isHero) {
                        ctx.fillStyle = pal.hair;
                        ctx.fillRect(cx-8, sy+by+3, 3, 7);
                        ctx.fillRect(cx+5, sy+by+3, 3, 7);
                        ctx.fillStyle = pal.hairDk;
                        ctx.fillRect(cx-4, sy+by-2, 2, 4);
                        ctx.fillRect(cx-1, sy+by-4, 2, 5);
                        ctx.fillRect(cx+3, sy+by-3, 2, 4);
                ...
                if (isHero) {
                    ...
                    ctx.fillRect(cx-9, sy+by+20, 18, 22);
                    ctx.fillStyle = pal.capeHL;
                    ctx.fillRect(cx-7, sy+by+20, 6, 18);
                    ctx.fillStyle = pal.capeMd || pal.capeDk;
                    ctx.fillRect(cx, sy+by+20, 2, 22);
                    ctx.fillStyle = pal.capeDk;
                    ctx.fillRect(cx+3, sy+by+21, 6, 21);
                    ctx.fillStyle = pal.capeEdge || pal.capeDk;
                    ctx.fillRect(cx-9, sy+by+40, 18, 2);
                    ctx.fillStyle = pal.cape;
                    for (let i = 0; i < 4; i++) ctx.fillRect(cx-7+i*4, sy+by+26, D, 12);
                    const capeW = moving ? Math.sin(frame*Math.PI/2)*2 : Math.sin(gt/1200)*0.5;
                    ctx.fillStyle = pal.capeDk;
                    ctx.fillRect(cx-6, sy+by+40+Math.round(capeW), 12, 2);
                } else {
                    ctx.fillStyle = pal.tunic;
                    ctx.fillRect(cx-8, sy+by+20, 16, 18);
                    ctx.fillStyle = pal.tunicHL;
                    ctx.fillRect(cx-6, sy+by+20, 6, 14);
                    ctx.fillStyle = pal.tunicDk;
                    ctx.fillRect(cx, sy+by+20, 2, 18);
                    ctx.fillRect(cx-8, sy+by+36, 16, 2);
                    ctx.fillStyle = pal.tunicTrim || pal.tunicHL;
                    ctx.fillRect(cx-8, sy+by+36, 16, D);
                    ctx.fillStyle = pal.tunicDk;
                    for (let i=0;i<3;i++) ctx.fillRect(cx-5+i*3, sy+by+26, D, 8);
                }
                ctx.fillStyle = pal.shoulder || pal.tunic;
                ell(cx-9, sy+by+24, 3, 3);
                ell(cx+9, sy+by+24, 3, 3);
                ...
                ctx.fillRect(cx-8, sy+by+38, 16, 3);
                ctx.fillStyle = pal.beltHL;
                ctx.fillRect(cx-4, sy+by+38, 8, D);
                const ulaOff = Math.round(armSwing);
                const uraOff = Math.round(-armSwing);
                ctx.fillStyle = pal.tunic;
                ctx.fillRect(cx-12+ulaOff, sy+by+22, 4, 8);
                ctx.fillRect(cx+8+uraOff, sy+by+22, 4, 8);
                ctx.fillStyle = pal.tunicDk;
                ctx.fillRect(cx-12+ulaOff, sy+by+29, 4, D);
                ctx.fillRect(cx+8+uraOff, sy+by+29, 4, D);
                ctx.fillStyle = pal.skin;
                ctx.fillRect(cx-11+ulaOff, sy+by+30, 3, 4);
                ctx.fillRect(cx+9+uraOff, sy+by+30, 3, 4);
                ctx.fillStyle = pal.skinSh;
                ctx.fillRect(cx-11+ulaOff, sy+by+33, 3, D);
                ctx.fillRect(cx+9+uraOff, sy+by+33, 3, D);
                ctx.fillStyle = pal.pants;
                ctx.fillRect(cx-6, y+2, 5, 12);
                ctx.fillRect(cx+1, y+2, 5, 12);
                ctx.fillStyle = pal.pantsDk;
            ...
            case 'left': {
                if (hasHat) {
                    ctx.fillStyle = pal.hat || pal.hair;
                    ell(cx-2, sy+by+4, 10, 6);
                    ctx.fillStyle = pal.hatHL || pal.hairHL;
                    ell(cx-3, sy+by+3, 7, 4);
                    ctx.fillStyle = pal.hatDk || pal.hairDk;
                    ctx.fillRect(cx-11, sy+by+6, 18, 2);
                } else {
                    ctx.fillStyle = pal.hairDk;
                    ell(cx-1, sy+by+5, 8, 8);
                    ctx.fillStyle = pal.hair;
                    ell(cx-1, sy+by+6, 7, 7);
                    ctx.fillStyle = pal.hairHL;
                    ell(cx-3, sy+by+4, 4, 3);
                    ctx.fillStyle = pal.hair;
                    ctx.fillRect(cx-8, sy+by+8, 7, 7);
                    if (isHero) {
                        ctx.fillStyle = pal.hairDk;
                        ctx.fillRect(cx-5, sy+by-2, 2, 4);
                        ctx.fillRect(cx-1, sy+by-3, 2, 4);
                        ctx.fillRect(cx+3, sy+by-1, 2, 3);
                    }
                }
                ctx.fillStyle = pal.skin;
                ell(cx-1, sy+by+12, 7, 6);
                ctx.fillStyle = pal.skinHL;
                ell(cx-2, sy+by+10, 4, 3);
                ctx.fillStyle = pal.skinSh;
                ctx.fillRect(cx-6, sy+by+16, 10, D);
                ctx.fillStyle = pal.skin;
                ctx.fillRect(cx-8, sy+by+12, 2, 3);
                ctx.fillStyle = pal.eyeW;
                ctx.fillRect(cx-5, sy+by+10, 4, 3);
                ctx.fillStyle = pal.eye;
                ctx.fillRect(cx-4, sy+by+10, 2, 2);
                ctx.fillStyle = pal.pupil || '#080830';
                ctx.fillRect(cx-5, sy+by+11, D, D);
                ctx.fillStyle = '#fff';
                ctx.fillRect(cx-3, sy+by+10, D, D);
                ctx.fillStyle = pal.outline;
                ctx.fillRect(cx-5, sy+by+9, 4, D);
                ctx.fillStyle = pal.nose || pal.skinSh;
                ctx.fillRect(cx-7, sy+by+13, 2, D);
                ctx.fillStyle = pal.mouth || pal.skinSh;
                ctx.fillRect(cx-4, sy+by+15, 4, D);
                ctx.fillStyle = pal.skin;
                ctx.fillRect(cx-2, sy+by+17, 5, 3);
                ctx.fillStyle = pal.skinSh;
                ctx.fillRect(cx-2, sy+by+18, 5, D);
                ctx.fillStyle = pal.collar || pal.tunicHL;
                ctx.fillRect(cx-6, sy+by+20, 12, 2);
                ctx.fillStyle = pal.shoulder || pal.tunic;
                ell(cx-9, sy+by+24, 3, 3);
                ctx.fillStyle = pal.tunic;
                ctx.fillRect(cx-7, sy+by+22, 14, 16);
                ctx.fillStyle = pal.tunicHL;
                ctx.fillRect(cx-5, sy+by+22, 5, 12);
                ctx.fillStyle = pal.tunicDk;
                ctx.fillRect(cx+3, sy+by+22, 4, 16);
                ctx.fillRect(cx-7, sy+by+36, 14, 2);
                ctx.fillStyle = pal.tunicTrim || pal.tunicHL;
                ctx.fillRect(cx-7, sy+by+37, 14, D);
                ctx.fillStyle = pal.tunicDk;
                ctx.fillRect(cx-3, sy+by+26, D, 8);
                ctx.fillRect(cx+1, sy+by+28, D, 6);
                if (hasApron) {
                    ctx.fillStyle = pal.apron || '#e0d0b0';
                    ctx.fillRect(cx-5, sy+by+30, 10, 8);
                    ctx.fillStyle = pal.apronSh || '#c0b090';
                ...
                ctx.fillStyle = pal.belt;
                ctx.fillRect(cx-7, sy+by+38, 14, 3);
                ctx.fillStyle = pal.beltHL;
                ctx.fillRect(cx-4, sy+by+38, 4, D);
                ctx.fillStyle = pal.beltBk;
                ctx.fillRect(cx+2, sy+by+38, 3, 3);
                if (isHero) {
                    ctx.fillStyle = pal.weapon;
                    ctx.fillRect(cx+6, sy+by+22, 2, 18);
                    ctx.fillStyle = pal.weaponHL;
                    ctx.fillRect(cx+6, sy+by+22, D, 16);
                    ctx.fillStyle = '#c0a040';
                    ctx.fillRect(cx+5, sy+by+38, 4, 2);
                }
                const lloOff = Math.round(armSwing);
                ctx.fillStyle = pal.tunic;
                ctx.fillRect(cx-11+lloOff, sy+by+22, 4, 8);
                ctx.fillStyle = pal.tunicDk;
                ctx.fillRect(cx-11+lloOff, sy+by+29, 4, D);
                ctx.fillStyle = pal.skin;
                ctx.fillRect(cx-10+lloOff, sy+by+30, 3, 4);
                ctx.fillStyle = pal.glove || pal.skinSh;
                ctx.fillRect(cx-10+lloOff, sy+by+34, 3, 3);
                ctx.fillStyle = pal.pants;
                ctx.fillRect(cx-5, y+2, 10, 12);
                ctx.fillStyle = pal.pantsDk;
                ctx.fillRect(cx-5, y+2, 3, 12);
                ctx.fillRect(cx-5, y+10, 10, 2);
                ctx.fillStyle = pal.pantsHL;
                ctx.fillRect(cx+1, y+2, 3, 8);
                ctx.fillStyle = pal.boots;
                ctx.fillRect(cx-6, y+14+legL, 6, 20);
                ctx.fillRect(cx+1, y+14+legR, 6, 20);
                ctx.fillStyle = pal.bootsCuff;
                ctx.fillRect(cx-6, y+14+legL, 6, 2);
                ctx.fillRect(cx+1, y+14+legR, 6, 2);
                ctx.fillStyle = pal.bootsDk;
                ctx.fillRect(cx-6, y+28+legL, 6, D);
                ctx.fillRect(cx+1, y+28+legR, 6, D);
                ctx.fillStyle = pal.bootsSole;
                ctx.fillRect(cx-7, y+34+legL, 8, 6);
                ctx.fillRect(cx, y+34+legR, 8, 6);
                ctx.fillStyle = pal.bootsDk;
                ctx.fillRect(cx-7, y+38+legL, 8, 2);
                ctx.fillRect(cx, y+38+legR, 8, 2);
                break;
            }
            case 'right': {
                if (hasHat) {
                    ...
                    ell(cx+3, sy+by+3, 7, 4);
                    ctx.fillStyle = pal.hatDk || pal.hairDk;
                    ctx.fillRect(cx-7, sy+by+6, 18, 2);
                } else {
                    ctx.fillStyle = pal.hairDk;
                    ell(cx+1, sy+by+5, 8, 8);
                    ctx.fillStyle = pal.hair;
                ...
                ell(cx+2, sy+by+10, 4, 3);
                ctx.fillStyle = pal.skinSh;
                ctx.fillRect(cx-4, sy+by+16, 10, D);
                ctx.fillStyle = pal.skin;
                ctx.fillRect(cx+6, sy+by+12, 2, 3);
                ctx.fillStyle = pal.eyeW;
                ctx.fillRect(cx+1, sy+by+10, 4, 3);
                ctx.fillStyle = pal.eye;
                ctx.fillRect(cx+2, sy+by+10, 2, 2);
                ctx.fillStyle = pal.pupil || '#080830';
                ctx.fillRect(cx+4, sy+by+11, D, D);
                ctx.fillStyle = '#fff';
                ctx.fillRect(cx+2, sy+by+10, D, D);
                ctx.fillStyle = pal.outline;
                ctx.fillRect(cx+1, sy+by+9, 4, D);
                ctx.fillStyle = pal.nose || pal.skinSh;
                ctx.fillRect(cx+5, sy+by+13, 2, D);
                ctx.fillStyle = pal.mouth || pal.skinSh;
                ctx.fillRect(cx, sy+by+15, 4, D);
                ctx.fillStyle = pal.skin;
                ctx.fillRect(cx-3, sy+by+17, 5, 3);
                ctx.fillStyle = pal.skinSh;
                ctx.fillRect(cx-3, sy+by+18, 5, D);
                ctx.fillStyle = pal.collar || pal.tunicHL;
                ctx.fillRect(cx-6, sy+by+20, 12, 2);
                ctx.fillStyle = pal.shoulder || pal.tunic;
                ell(cx+9, sy+by+24, 3, 3);
                ...
                ctx.fillRect(cx-7, sy+by+22, 14, 16);
                ctx.fillStyle = pal.tunicHL;
                ctx.fillRect(cx, sy+by+22, 5, 12);
                ctx.fillStyle = pal.tunicDk;
                ctx.fillRect(cx-7, sy+by+22, 4, 16);
                ctx.fillRect(cx-7, sy+by+36, 14, 2);
                ctx.fillStyle = pal.tunicTrim || pal.tunicHL;
                ctx.fillRect(cx-7, sy+by+37, 14, D);
                ctx.fillStyle = pal.tunicDk;
                ctx.fillRect(cx+2, sy+by+26, D, 8);
                ctx.fillRect(cx-2, sy+by+28, D, 6);
                if (hasApron) {
                    ctx.fillStyle = pal.apron || '#e0d0b0';
                    ctx.fillRect(cx-5, sy+by+30, 10, 8);
                    ctx.fillStyle = pal.apronSh || '#c0b090';
                ...
                ctx.fillRect(cx-7, sy+by+38, 14, 3);
                ctx.fillStyle = pal.beltHL;
                ctx.fillRect(cx, sy+by+38, 4, D);
                ctx.fillStyle = pal.beltBk;
                ctx.fillRect(cx-5, sy+by+38, 3, 3);
                if (isHero) {
                    ctx.fillStyle = pal.weapon;
                    ctx.fillRect(cx-8, sy+by+22, 2, 18);
                    ctx.fillStyle = pal.weaponHL;
                    ctx.fillRect(cx-7, sy+by+22, D, 16);
                    ctx.fillStyle = '#c0a040';
                    ctx.fillRect(cx-9, sy+by+38, 4, 2);
                }
                const rroOff = Math.round(-armSwing);
                ctx.fillStyle = pal.tunic;
                ctx.fillRect(cx+8+rroOff, sy+by+22, 4, 8);
                ctx.fillStyle = pal.tunicDk;
                ctx.fillRect(cx+8+rroOff, sy+by+29, 4, D);
                ctx.fillStyle = pal.skin;
                ctx.fillRect(cx+8+rroOff, sy+by+30, 3, 4);
                ctx.fillStyle = pal.glove || pal.skinSh;
                ctx.fillRect(cx+8+rroOff, sy+by+34, 3, 3);
                ctx.fillStyle = pal.pants;
                ctx.fillRect(cx-5, y+2, 10, 12);
                ctx.fillStyle = pal.pantsDk;
                ctx.fillRect(cx+2, y+2, 3, 12);
                ctx.fillRect(cx-5, y+10, 10, 2);
                ctx.fillStyle = pal.pantsHL;
                ctx.fillRect(cx-4, y+2, 3, 8);
                ctx.fillStyle = pal.boots;
                ctx.fillRect(cx-7, y+14+legL, 6, 20);
                ctx.fillRect(cx, y+14+legR, 6, 20);
                ctx.fillStyle = pal.bootsCuff;
                ctx.fillRect(cx-7, y+14+legL, 6, 2);
                ctx.fillRect(cx, y+14+legR, 6, 2);
                ctx.fillStyle = pal.bootsDk;
                ctx.fillRect(cx-7, y+28+legL, 6, D);
                ctx.fillRect(cx, y+28+legR, 6, D);
                ctx.fillStyle = pal.bootsSole;
                ctx.fillRect(cx-8, y+34+legL, 8, 6);
                ctx.fillRect(cx-1, y+34+legR, 8, 6);
                ctx.fillStyle = pal.bootsDk;
                ctx.fillRect(cx-8, y+38+legL, 8, 2);
                ctx.fillRect(cx-1, y+38+legR, 8, 2);
                break;
            }
        }
    }
